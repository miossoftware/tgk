...
if ($islem == "ogr_randevu_ver_modal") {
    ?>
                ...
                <div class="page-content fade-in-up">
                    <div class="ibox">
                        <div class="ibox-head" style='background-color:#9DB2BF'>
                            <div class="ibox-title" style='color:white; font-weight:bold;'>RANDEVU OLUŞTUR</div>
                        </div>
    ...
    <script>
        ...
        $("body").off("click", "#kaydet_button").on("click", "#kaydet_button", function () {
            ...
            if (saat_aralik == "") {
                ...
                $.ajax({
                    url: "../controller/randevu_controller/sql.php?islem=randevuyu_kaydet_sql",
                    type: "POST",
                    data: {
                        okul_adi: okul_adi,
