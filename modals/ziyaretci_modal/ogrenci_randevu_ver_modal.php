...
if ($islem == "ogrenci_bilgi_giris_modal") {
    ?>
                        ...
                        <div class="modal-body" style="max-height: 75vh; overflow: auto;">
                            <div class="col-12 row">
                                <div class="form-group row">
                                    <div class="col-md-3">
                                        <label>Öğrenci Adı/TC</label>
                                    </div>
                                    <div class="col-md-7 row no-gutters">
                                        <div class="col">
                                            <input type="text" class="form-control form-control-sm" id="ogr_adi"
                                                   placeholder="Öğrenci Adı Giriniz...">
                                        </div>
                                        <div class="col">
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-sm"
                                                       placeholder="TC Kimlik No Giriniz..." id="ogr_tc">
                                                <div class="input-group-append">
                                                    <button class="btn btn-success btn-sm" id="listeye_ogr_ekle"><i
