...
<head>
    ...
    <title>Tarsus Gençlik Kampı</title>
</head>
<style>
    ...
    <div class="site-navbar-wrap">
        ...
        <div class="site-navbar site-navbar-target js-sticky-header">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-2">
                        <h1 class="my-0 site-logo" ><a href="" style="color: #2C7865">GENÇLİK KAMPI</a></h1>
                    </div>
                                ...
                                <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                                    <li class="">
                                        <a href="view/admin_panel.php">
                                            <button class="btn btn-sm" style="background-color: #2C7865; color:white;" id="personel_giris_button">
                                                <i class="fa fa-sign-in"></i> Personel Girişi
                                            </button>
                                        </a>
                                    </li>
                                    <li class="">
                                        <a href="view/user_panel.php">
                                            <button class="btn btn-sm" style="background-color: #2C7865; color:white;" id="kurum_girisi_yap_button">
                                                <i class="fa fa-sign-in"></i> Kurum Girişi
                                            </button>
                                        </a>
                                    </li>
                                </ul>
