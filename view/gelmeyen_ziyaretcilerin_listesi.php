<div class="ibox-container">
    <div class="ibox mt-5">
        <div class="ibox-head">
            <div class="ibox-title" style=' font-weight:bold;'>GELMEYEN ZİYARETÇİLERİN LİSTESİ</div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $.get("../controller/randevular_controller/sql.php?islem=gelmeyen_kurumlar_controller", function (res) {
            if (res != 2) {
